      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Comprehensive curriculum designed to develop all aspects of emotional intelligence for leadership excellence.
            </p>
          </div>
            ...
            <Card className="border-0 shadow-elegant hover:shadow-xl transition-shadow">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-foreground/80">Emotional self-awareness and recognition</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Identifying personal triggers and patterns</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Understanding your emotional impact on others</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Accurate self-assessment techniques</p>
                </div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-elegant hover:shadow-xl transition-shadow">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-foreground/80">Emotional self-control techniques</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-accent mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Stress management and resilience building</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-accent mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Adaptability and flexibility development</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-accent mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Maintaining optimism under pressure</p>
                </div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-elegant hover:shadow-xl transition-shadow">
              <CardHeader>
                <CardTitle className="text-xl flex items-center gap-2">
                  <Heart className="h-5 w-5 text-energy" />
                  Social Awareness Skills
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-energy mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Reading non-verbal communication</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-energy mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Empathy and perspective-taking</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-energy mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Understanding group dynamics</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-energy mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Cultural and organizational awareness</p>
                </div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-elegant hover:shadow-xl transition-shadow">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Influence and persuasion techniques</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Conflict resolution and mediation</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Team leadership and collaboration</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                  <p className="text-foreground/80">Inspirational leadership techniques</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              <span className="gradient-text">Your EI Development Journey</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              A structured approach to developing emotional intelligence that delivers lasting results.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center hover:shadow-lg transition-all duration-300 border-0 shadow-card group">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  Evaluate your current emotional intelligence level and identify areas for improvement.
                </p>
              </CardContent>
            </Card>
            <Card className="text-center hover:shadow-lg transition-all duration-300 border-0 shadow-card group">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  Learn and practice the four core components of emotional intelligence.
                </p>
              </CardContent>
            </Card>
            <Card className="text-center hover:shadow-lg transition-all duration-300 border-0 shadow-card group">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  Apply emotional intelligence skills in real-world scenarios and challenges.
                </p>
              </CardContent>
            </Card>
            <Card className="text-center hover:shadow-lg transition-all duration-300 border-0 shadow-card group">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  Integrate emotional intelligence into your daily leadership and communication style.
                </p>
              </CardContent>
            </Card>
          </div>
